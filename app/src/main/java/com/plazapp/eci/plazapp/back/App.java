...
public class App {
    ...
    public static boolean handleLogin(String userName, String password){
        ...
        if (users.containsKey(userName)){
            ans = users.get(userName).correctPass(password);
            if (ans){
    ...
    public static boolean handleRegister(String userName,String email, String rating, String pass, String urlPhoto){
        boolean ans = false;
        if (!users.containsKey(email)){
            users.put(email,new User(userName,email,rating,pass, urlPhoto));
            ans = users.containsKey(email);
        }
        return ans;
    }
